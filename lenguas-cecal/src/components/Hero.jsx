...
export const Hero = () => {
    return (
        <>
            <main className="flex flex-col items-center justify-center gap-5 w-full h-svh">
                ...
                <div className="flex flex-col items-center justify-center gap-1">
                    <h1 className="text-7xl">Aprende idiomas con los</h1>
                    <span className="text-6xl text-primary font-bold">mejores profesionales</span>
                </div>
                <p className="text-tertiary text-lg text-center">Mas de 38 años formando estudiantes en ingles, portugues, <br /> italiano, frances y aleman. Clases presenciales y online con <br /> metodologia personalizada.</p>
